...
params['comment'] = f"Experiment 6 (2024/4/30): phi_x_on = {_phi_x_on} and I_m_factor = 15"
as_step_parameter = np.s_[::100]

insert_four_well = True
compensation_for_asym = False
time_scale = 1
...
phi_1_x_on = _phi_x_on
phi_2_x_on = _phi_x_on
phi_1_dcx_on = 3.0
phi_2_dcx_on = 3.0
M_12_on = -0.6
...
protocol_list = [
# forward
{"duration":50, "phi_2_x": phi_2_x_on * 0.2,  "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on * 0.5,  "M_12": M_12_off,  "name":"(1) mix in y direction (a)"},
...
{"duration":200, "phi_1_x": phi_1_x_on * 0.2, "phi_1_dcx": phi_1_dcx_on * 0.5, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(6) return to 4 well potential (a)"}, 
