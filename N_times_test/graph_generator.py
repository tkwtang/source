...
params['comment'] = "Experiment 5 (2024/7/5): Try to use t = 200 from conditional tilt back to the 4 well, N = 10_000, dt = 1/5000"
...
#phi_1_x_on = -0.1938
#phi_2_x_on = -0.1938
for _dcx in np.linspace(1.8, 2.7, 10):
    phi_1_dcx_on = _dcx
    phi_2_dcx_on = _dcx
    M_12_on = -0.6
    ...
    protocol_list = [
        # forward
        {"duration":50 * time_scale, "phi_2_x": phi_2_x_on * 0.1,  "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on * 0.5,  "M_12": M_12_off,  "name":"(1) mix in y direction (a)"},
        {"duration":200 * time_scale,"phi_2_x": phi_2_x_on, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on,  "M_12": M_12_off,  "name":"(1) mix in y direction (b)"},
        {"duration":60 * time_scale, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on,  "M_12": M_12_on,   "name":"(2) conditional tilt"},
        {"duration":60 * time_scale, "phi_1_x": phi_1_x_on, "phi_2_x": phi_2_x_off, "phi_1_dcx": phi_1_dcx_on,  "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_on,  "name": "(4) conditional tilt in x"}, 
        {"duration":60 * time_scale, "phi_1_dcx": phi_1_dcx_on,  "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(5) mix in x direction"}, 
    ...
    if insert_four_well:
        protocol_list = [
        # forward
        # {"duration":10 * time_scale, "phi_2_x": phi_1_x_off,  "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off,  "M_12": M_12_off,  "name":"(0) do nothing"},
        ...
        # {"duration":200 * time_scale, "phi_2_x": phi_2_x_off, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(3) return to 4 well"},
        # {"duration":200 * time_scale, "phi_1_x": phi_1_x_on, "phi_2_x": phi_1_x_off, "phi_1_dcx": phi_1_dcx_on,  "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_on,  "name": "(4) conditional tilt in x"}, 
    ...
    plotLineData = cfqr.plotGraph(t = protocol_time_array[-1], cutlineDirection = "v", cutlineValue = -1.96)
    plotLineData["dcx"] = _dcx
    np.save(f"../coupled_flux_qubit_protocol/coupled_flux_qubit_data_gallery/{uuid.uuid4().hex}_plotline_graph.npy", plotLineData)
