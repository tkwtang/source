...
params['comment'] = "Experiment 1d (2024/2/22): 50 and 200 of step 1 and step 5 and try to find the substep work, with dt = 1/10000, but with I_m ≠ 0"
...
for _I_m in [5, 9]:
    ...
    protocol_list = [
        ...
        {"duration":200, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on, "M_12": M_12_off,  "name":"return to 4 well potential"},
         {"duration":50, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(6) 4 well potential"}, 
        # {"duration":200, "phi_1_dcx": phi_1_dcx_off * 0.5, "phi_2_dcx": phi_2_dcx_on, "M_12": M_12_on * 0.5,  "name":"return to 4 well potential"},
        ...
        # {"duration":200, "phi_1_dcx": phi_1_dcx_on * 0.5, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"return to 4 well potential"}, 
        # {"duration":50, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(6) 4 well potential"}, 
    ]
