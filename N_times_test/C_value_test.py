...
params['comment'] = "Experiment 7 (2024/3/17): C_factor Test for C = [0.1, 0.5, 1.0, 5.0, 10.0, 50.0] with I_m_factor = 1 and compensation under 4 wells"
as_step_parameter = np.s_[::100]

# override parameters
for _C_factor in [0.1, 0.5, 1, 5, 10, 50, 100, 500, 1000]:
