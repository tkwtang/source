...
params['comment'] = "Experiment 2 (2024/6/27): symmetric protocol time length, use C_factor = 1"
...
if insert_four_well:
    ...
    {"duration":100 * time_scale,"phi_2_x": phi_1_x_on, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on,  "M_12": M_12_off,  "name":"(1) mix in y direction (b)"},
    ...
    {"duration":100 * time_scale, "phi_1_x": phi_1_x_on * 0.1, "phi_1_dcx": phi_1_dcx_on * 0.5, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(6) return to 4 well potential (a)"}, 
    {"duration":50 * time_scale,  "phi_1_x": phi_1_x_off, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(6) 4 well potential (b)"}, 
]
