...
params['comment'] = "Experiment 4.1 (2024/6/27): Just first half of the protocol"
...
cfq_batch_sweep.saveSimulationResult(simResult, U0_1, timeOrStep = 'step', save = True, save_final_state = False, saveFolderPath = 
"../coupled_flux_qubit_protocol/coupled_flux_qubit_data_gallery", save_animation = True)
