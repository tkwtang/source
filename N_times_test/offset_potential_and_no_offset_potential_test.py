...
from edward_tools.coupled_fq_potential import coupled_flux_qubit_pot, coupled_flux_qubit_pot_with_offset_at_0000, coupled_flux_qubit_force, coupled_fq_pot
...
N = 10_000
dt = 1/1_000
_test_comment = "Experiment 2 (2024/1/30) Work done in full protocol of offset potential, 用 min work done in each substep protocol 的縫合怪，再加上 offset 的 protocol，用來找出每個 substage 所要花的 workdone。"


# this one is for testing gamma
...
params['circuit_params'] = {"I_p_1": I_p_1, "I_p_2": I_p_2, "I_m_1": I_m_1, "I_m_2": I_m_2, 
                        "R_1": R_1, "R_2": R_2, "C_1": C_1, "C_2": C_2, "L_1": L_1, "L_2": L_2
                       }
params['comment'] = _test_comment
...
protocol_list = [
    ...
    {"duration": 150, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(6) 4 well potential"}, 
