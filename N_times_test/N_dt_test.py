...
for _N in [1000, 5000, 50000]:
    ...
    params['comment'] = "Experiment 1 (2024/3/20): N = 1000, 5000 and 50000"
    ...
    if insert_four_well:
        protocol_list.insert(3, {"duration":200, "phi_2_x": phi_2_x_off, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(3) return to 4 well"})
