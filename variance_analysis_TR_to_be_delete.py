...
protocol_list= [
    {"duration": 60, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on,  "M_12": M_12_off,  "name":"(1) drop potential and mix in y direction"},
    rest(60), 
    ...
    rest(40), 
    {"duration":60, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_off, "M_12": M_12_off,  "name":"(6) 4 well potential"}, 
...
# import json
# jsonPath = "cfq_data/fidelity_r_analysis_step_1_to_6.json"
