...
experiment_idenitfication = f"Experiment {index_array[index_choice]} (2025-07-03)"
experiment_comment = f"{experiment_idenitfication}: fidelity analysis of harmonic potential with beta = 1.5 and with friction"
