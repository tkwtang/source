...
params['comment'] = "Experiment 3 (2024/7/24): Check the effect of longer duration to the case with C_factor = 50 at T = 7K"


for _t in [150, 200, 250, 300]:
    ...
    protocol_list = [
        # forward
        create_CE_Protocol(_t, CE_1),
        create_CE_Protocol(_t, four_well)
