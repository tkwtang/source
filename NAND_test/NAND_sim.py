...
mu_factor_pair = [0, (0.30, 0.45), (0.30, 0.40), (0.30, 0.40)]
index_choice = 1

experiment_comment = f"Experiment {index_array[index_choice]} (2025/6/7): work cost analysis of harmonic potential with beta = 1.5 and mu_factor = {mu_factor_pair[index_choice]}"
...
mu_factor_h0 = mu_factor_pair[index_choice][0]
mu_factor_h1 = mu_factor_pair[index_choice][1]
...
if beta_1 == 1.35:
    ...
    mu_factor_h1 = 0.45
    protocol_harmonic_h0 = {"phi_1x": 0.0, "phi_2x": 0.0, "mu_12": 0.0, "phi_1xdc": 0, "phi_2xdc": 0, "name": "four_well", "color": "r", "linestyle": "-"} 
    protocol_harmonic_h1 = {"phi_1x": 0.1 * mu_factor_h0, "phi_2x": 0.0, "mu_12": 0.05 * mu_factor_h0, "phi_1xdc": 0.7, "phi_2xdc": 0, "name": "h1", "color": "r", "linestyle": "-"} 
    protocol_harmonic_h2 = {"phi_1x": 0.1 * mu_factor_h0, "phi_2x": 0.0, "mu_12": 0.078 * mu_factor_h0, "phi_1xdc": 1.6, "phi_2xdc": 0, "name": "h2", "color": "g", "linestyle": "-"} 
    protocol_harmonic_h3 = {"phi_1x": 0.1 * mu_factor_h1, "phi_2x": 0.0, "mu_12": 0.078 * mu_factor_h1, "phi_1xdc": 0.8, "phi_2xdc": 0, "name": "h3", "color": "b", "linestyle": "-"} 
    # protocol_harmonic_h4 = {"phi_1x": 0. * mu_factor_h0, "phi_2x": 0.0, "mu_12": 0.00 * mu_factor_h0, "phi_1xdc": 1.0, "phi_2xdc": 0, "name": "harmonic", "color": "r", "linestyle": "-"} 
    cutline_value = 1.3


    protocol_list_harmonic = [
        # createProtocol(10, protocol_harmonic_h1, name = "harmonic"),
        createProtocol(15, protocol_harmonic_h2, name = "flip erasure"),
        createProtocol(18, protocol_harmonic_h3, name = "raise barrier"),
