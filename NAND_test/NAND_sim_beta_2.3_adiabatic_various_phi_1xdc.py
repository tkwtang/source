...
experiment_comment = f"{experiment_idenitfication}: fidelity analysis of adiabatic potential with beta = 2.3 and with different barrier height"
simParams = np.linspace(0,1,100)
simParams = np.linspace(0,1,1)
simParams = [1.94, 1.99, 2.01, 2.02, 2.03, 2.04, 2.05, 2.06, 2.07, 2.08, 2.09, 2.10]
