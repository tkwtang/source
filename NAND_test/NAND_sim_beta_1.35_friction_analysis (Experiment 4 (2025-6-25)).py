...
experiment_idenitfication = f"Experiment {index_array[index_choice]} (2025/6/25)"
experiment_comment = f"{experiment_idenitfication}: fidelity analysis of harmonic potential with beta = 1.35 and no friction, 2nd try to remove error in 00 particle"
simParams = np.linspace(0,1,100)
...
if beta_1 == 1.35:
    ...
    mu_factor_h1 = 0.80
    protocol_harmonic_h0 = {"phi_1x": 0.0, "phi_2x": 0.0, "mu_12": 0.0, "phi_1xdc": 0, "phi_2xdc": 0, "name": "four_well", "color": "r", "linestyle": "-"} 
    protocol_harmonic_h2 = {"phi_1x": 0.1 * mu_factor_h0, "phi_2x": 0.0, "mu_12": 0.076 * mu_factor_h0, "phi_1xdc": 1.7, "phi_2xdc": 0, "name": "h2", "color": "g", "linestyle": "-"} 
    protocol_harmonic_h3 = {"phi_1x": 0.1 * mu_factor_h1, "phi_2x": 0.0, "mu_12": 0.076 * mu_factor_h1, "phi_1xdc": 0.5, "phi_2xdc": 0, "name": "h3", "color": "b", "linestyle": "-"} 
    # protocol_harmonic_h4 = {"phi_1x": 0. * mu_factor_h0, "phi_2x": 0.0, "mu_12": 0.00 * mu_factor_h0, "phi_1xdc": 1.0, "phi_2xdc": 0, "name": "harmonic", "color": "r", "linestyle": "-"} 
    cutline_value = 1.3
