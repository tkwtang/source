...
for database in GALLERY_DATABASE_ARRAY:
    ...
    try:
        ...
        print(f"The sid does not exist in {database}")
        pass
...
experiment_comment = target.head(1)['comment'].values[0]
...
protocol_list = target.head(1)['protocol_list_item'].values[0]

# modify protocol_list
