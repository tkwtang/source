...
experiment_idenitfication = f"Experiment {index_array[index_choice]} (2025-08-19)"
# experiment_idenitfication = "test"
experiment_comment = f"{experiment_idenitfication}: fidelity analysis of harmonic potential with beta = 1.35 and with friction"
...
params['sim_params'] = [_lambda, _theta, _eta]
params['saveAllStates'] = saveAllStates
params['has_velocity'] = has_velocity
...
if beta_1 == 2.3:
    ...
    protocol_harmonic_h0_5 = {"phi_1x": 0.0, "phi_2x": 0.0, "mu_12": 0, "phi_1xdc": 1.9, "phi_2xdc": 0, "name": "h0_5", "color": "grey", "linestyle": "-"} 
    protocol_harmonic_h1 = {"phi_1x": 0.1 * mu_factor_h1, "phi_2x": 0.0, "mu_12": 0.05 * mu_factor_h1, "phi_1xdc": 2.00, "phi_2xdc": 0, "name": "h1", "color": "r", "linestyle": "-"} 
    protocol_harmonic_h2 = {"phi_1x": 0.1 * mu_factor_h2, "phi_2x": 0.0, "mu_12": 0.05 * mu_factor_h2, "phi_1xdc": 2.30, "phi_2xdc": 0, "name": "h2", "color": "g", "linestyle": "-"} 
    protocol_harmonic_h3 = {"phi_1x": 0.1 * mu_factor_h3, "phi_2x": 0.0, "mu_12": 0.05 * mu_factor_h3, "phi_1xdc": 2.00, "phi_2xdc": 0, "name": "h3", "color": "b", "linestyle": "-"} 
    # protocol_harmonic_h4 = {"phi_1x": 0. * mu_factor_h0, "phi_2x": 0.0, "mu_12": 0.00 * mu_factor_h0, "phi_1xdc": 1.0, "phi_2xdc": 0, "name": "harmonic", "color": "r", "linestyle": "-"} 
    cutline_value = 2

    protocol_list_harmonic = [
        
        createProtocol(100, protocol_harmonic_h0_5, name = "flip erasure"),
        ...
        createProtocol(15, protocol_harmonic_h0_5, name = "four well"),
        createProtocol(100, protocol_harmonic_h0, name = "four well"),
...
cfq_batch_sweep.saveSimulationResult(simResult, U0_1, timeOrStep = 'step', save = True, save_final_state = True, 
                                     saveFolderPath = "../coupled_flux_qubit_protocol/coupled_flux_qubit_data_gallery")
