...
simParams = np.linspace(0,1,500)

# mu_factor_h0 and mu_factor_h1
...
for _ in simParams:
    ...
    experiment_idenitfication = f"Experiment {index_array[index_choice]} (2025-07-10)"
    experiment_comment = f"{experiment_idenitfication}: fidelity analysis of harmonic potential with beta = 1.4 and with friction"
    ...
    beta_1, beta_2 = [1.4]*2 # barrier kBT = 100
    ...
    if beta_1 == 1.4:
        ...
        protocol_harmonic_h2 = {"phi_1x": 0.1 * mu_factor_h2, "phi_2x": 0.0, "mu_12": 0.0715 * mu_factor_h2, "phi_1xdc": 1.7, "phi_2xdc": 0, "name": "h2", "color": "g", "linestyle": "-"} 
        protocol_harmonic_h3 = {"phi_1x": 0.1 * mu_factor_h3, "phi_2x": 0.0, "mu_12": 0.0715 * mu_factor_h3, "phi_1xdc": 0, "phi_2xdc": 0, "name": "h3", "color": "b", "linestyle": "-"} 
    ...
    if beta_1 == 1.4:
        # for beta = 1.5
        protocol_harmonic_h0 = {"phi_1x": 0.0, "phi_2x": 0.0, "mu_12": 0.0, "phi_1xdc": 0, "phi_2xdc": 0, "name": "four_well", "color": "r", "linestyle": "-"} 
        protocol_harmonic_h1 = {"phi_1x": 0.0, "phi_2x": 0.0, "mu_12": 0.0, "phi_1xdc": 0, "phi_2xdc": 0.6, "name": "pre-flip", "color": "r", "linestyle": "-"} 
        protocol_harmonic_h2 = {"phi_1x": 0.1 * mu_factor_h2, "phi_2x": 0.0, "mu_12": 0.0715 * mu_factor_h2, "phi_1xdc": 1.7, "phi_2xdc": 0, "name": "h2", "color": "g", "linestyle": "-"} 
        protocol_harmonic_h3 = {"phi_1x": 0.1 * mu_factor_h3, "phi_2x": 0.0, "mu_12": 0.0715 * mu_factor_h3, "phi_1xdc": 0.6, "phi_2xdc": 0, "name": "h3", "color": "b", "linestyle": "-"} 
        # protocol_harmonic_h4 = {"phi_1x": 0. * mu_factor_h0, "phi_2x": 0.0, "mu_12": 0.00 * mu_factor_h0, "phi_1xdc": 1.0, "phi_2xdc": 0, "name": "harmonic", "color": "r", "linestyle": "-"} 
        cutline_value = 1.4


        protocol_list_harmonic = [
            createProtocol(20, protocol_harmonic_h1, name = "flip erasure"),
            createProtocol(12, protocol_harmonic_h2, name = "flip erasure"),
