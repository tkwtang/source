...
if not os.path.exists(initial_state_folder):
    os.makedirs(initial_state_folder)



initial_potential_protocol_list = [create_CE_Protocol(100,  {"phi_1x": 0.0, "phi_2x": 0.0, "mu_12": 0.0, "phi_1xdc": 0, "phi_2xdc": 0, "name": "four_well", "color": "r", "linestyle": "-"} )]
...
saved_path = os.path.join(initial_state_folder, f"four_well_default_init_state_{sim_id}.npy")
print(saved_path)
np.save(saved_path, init_state_saved)