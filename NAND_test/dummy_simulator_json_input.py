...
# json_location = "test_export.json"
...
initial_parameter_dict = data['initial_parameter_dict']

experiment_comment = params['comment']


PHI_0 = 2.067833848 * 1e-15
k_B = 1.38e-23
T = params['circuit_parameters']['T']
k_BT = params['k_BT']

C_factor = params['circuit_parameters']['C_factor']
L_factor = params['circuit_parameters']['L_factor']
R_factor = params['circuit_parameters']['R_factor']
I_m_factor = params['circuit_parameters']['I_m_factor']
time_scale = 1.0

I_p_1, I_p_2 = params['circuit_parameters']['I_p_1'], params['circuit_parameters']['I_p_2']  # Amp
I_m_1, I_m_2 = params['circuit_parameters']['I_m_1'], params['circuit_parameters']['I_m_2']  # Amp
R_1, R_2 = params['circuit_parameters']['R_1'], params['circuit_parameters']['R_2']
C_1, C_2 = params['circuit_parameters']['C_1'], params['circuit_parameters']['C_2']
L_1, L_2 = params['circuit_parameters']['L_1'], params['circuit_parameters']['L_2']
...
gamma = params['circuit_parameters']['gamma']
beta_1, beta_2 = initial_parameter_dict['beta_1'], initial_parameter_dict['beta_2'] # barrier KBT = 400
d_beta_1, d_beta_2 = initial_parameter_dict['d_beta_1'], initial_parameter_dict['d_beta_2']
...
coupled_fq_pot = Potential(coupled_flux_qubit_non_linear_approx_pot, coupled_flux_qubit_non_linear_approx_force, 14, 4, default_params = initial_parameter_dict,  relevant_domain = coupled_fq_domain)
...
mapping_dict = params['mapping_state_1_to_state_2_dict']
protocol_list = data['protocol_list_item']
...
failure_particles = simResult['failure_particles']
print(f"{RED} The number of failure particles: = {len(failure_particles)} {RESET}")
number_of_failure_particles = len(failure_particles)
if number_of_failure_particles > 0:
