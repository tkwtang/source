...
comment = "testing"
time_factor_array = [0, 0.25, 0.5, 1, 5, 10]
expt_index = 5
time_factor = time_factor_array[expt_index]
experiment_comment = f"Experiment {expt_index} (2025/6/6): time_factor analysis of Adiabatic Protocol (time_factor = {time_factor})"
...
protocol_list_adiabatic = [
    createProtocol(40 * time_factor, protocol_2, name = "acceleration_potential"),
    createProtocol(40 * time_factor, protocol_2, name = "acceleration_potential_hold"),
    ...
    {'duration': 40.0 * time_factor, "phi_1x": 0.0, "phi_2x": 0.0, "mu_12": 0.00, "phi_1xdc": 0, "phi_2xdc": 0, "name": "four_well"}
]  
