...
for _ in range(0, 50):
    ...
    # for _dt in [1/100]:
        ...
        params['comment'] = "Experiment 2 (2024/10/14): very long protocol with erasure and flip"
        ...
        fixed_time = 200
        protocol_list = [
            # create_CE_Protocol(1000, {
            #     "phi_1_x": 0, "phi_2_x": 0, "M_12": 0,  
            #     "phi_1_dcx": 0, "phi_2_dcx": 2.4, "name":"lower barrier"
            # }),
            # create_CE_Protocol(100, {
            #     "phi_1_x": 0, "phi_2_x": 0, "M_12": 0,  
            #     "phi_1_dcx": 0, "phi_2_dcx": 2.5, "name":"lower barrier"
            # }),
            create_CE_Protocol(2000, {
                "phi_1_x": 0, "phi_2_x": 0, "M_12": 0,  
                "phi_1_dcx": 0, "phi_2_dcx": np.pi, "name":"lower barrier"
            }),
            create_CE_Protocol(2000, flip_V),
            create_CE_Protocol(2000, four_well)
