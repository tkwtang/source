...
df = loadDataFrame(folderPath="../coupled_flux_qubit_protocol/coupled_flux_qubit_data_gallery")
...
mapping_dict = {'00': ['00'], '01': ['01'], '10': ['00'], '11': ['11']}
...
init_state_used = np.load(f"../coupled_flux_qubit_protocol/coupled_flux_qubit_data_gallery/{sim_id}_final_state.npy")
...
simResult['simulation_data']['parent_simulation_id'] = sim_id
