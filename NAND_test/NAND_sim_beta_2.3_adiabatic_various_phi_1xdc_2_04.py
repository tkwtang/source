...
experiment_idenitfication = f"Experiment {index_array[index_choice]} (2025-07-15)"
# experiment_idenitfication = "test"
experiment_comment = f"{experiment_idenitfication}: test adiabatic variation of time and barrier height"
simParams = np.linspace(0,1,100)
simParams = np.linspace(0,1,1)

time_array = [80]
params_array = [(2.02, -0.6)]
...
# beta = 2.3
for [_t, (_phi_1xdc, mu_factor_1)] in simParams:
    if beta_1 == 2.3:
