...
experiment_idenitfication = f"Experiment {index_array[index_choice]} (2025-07-08)"
...
if beta_1 == 1.35:
    mu_factor_1 = -1.10
    protocol_1_q = {"phi_1x": 0. * mu_factor_1, "phi_2x": 0, "mu_12": 0. * mu_factor_1, "phi_1xdc": 0.95, "phi_2xdc": 0, "name": "acceleration_protocol_0", "color": "g", "linestyle": "-"}
    protocol_2 = {"phi_1x": 0.09 * mu_factor_1, "phi_2x": 0, "mu_12": 0.06 * mu_factor_1, "phi_1xdc": 0.0, "phi_2xdc": 0, "name": "acceleration", "color": "r", "linestyle": "-"}
    cutline_value = 1.5


protocol_list = [
    createProtocol(30, protocol_2, name = "acceleration_potential"),
    createProtocol(30, protocol_2, name = "acceleration_potential_hold"),
