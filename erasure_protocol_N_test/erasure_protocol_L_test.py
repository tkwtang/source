...
params['comment'] = "Experiment 5 (2024/2/24): check for erasure only protocol, what is the effect of changing L from 0.3 to 5.0 affect the work done [0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 2.5, 5.0]"

for _L_factor in [0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 2.5, 5.0]:
    ...
    protocol_list = [
        # forward
        {"duration":50, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on * 0.5,  "M_12": M_12_off,  "name":"(1.1) mix in y direction"},
        {"duration":300, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on,  "M_12": M_12_off,  "name":"(1.2) mix in y direction"},
        {"duration":60, "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on,  "M_12": M_12_on,   "name":"(2) conditional tilt in y"},
